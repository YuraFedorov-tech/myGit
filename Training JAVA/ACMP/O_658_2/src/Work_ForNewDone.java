...
double SqwearTrangle=0;
		...
		for(int i=first+1;i<coordinat[0].length;i++){
...
//	 System.out.print(findOrNo+"\t");
	...
	boolean GoodTrangle=Find_GoodTrangle_Sqwear(x1,x2,x3,y1,y2,y3,coordinat[0][i],coordinat[1][i],SqwearTrangle);
	...
	//		return 0;
		...
		boolean CountTR=Find_CountTR(y1,y2,y3,coordinat[1][i]);
